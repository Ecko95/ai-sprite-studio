...
async def _root(request):
    ...
    response = HTMLResponse(
        ...
        "<p><label>Density boost <input type=\"number\" name=\"density\" value=\"1\" "
        "min=\"1\" max=\"2\" step=\"0.05\" style=\"width:4em\"></label> "
        "<small>pre-snap upscale so the recovered sprite fills more of the cell; try 1.5 if frames look small</small></p>"
